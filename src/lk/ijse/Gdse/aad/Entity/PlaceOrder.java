...
import lk.ijse.Gdse.aad.Dto.CartDetailDto;
...
public class PlaceOrder implements SuperEntity{
    ...
    public PlaceOrder(String o_id, String c_id, String date, double total, double discount, double subtotal, ArrayList<CartDetail> orderdetail) {
        O_id = o_id;
        C_id = c_id;
        this.date = date;
        this.total = total;
